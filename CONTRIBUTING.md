...
Welcome to `kw-haw-pkg1` contributor's guide.
...
If you experience bugs or general issues with `kw-haw-pkg1`, please have a look
...
You can help improve `kw-haw-pkg1` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`kw-haw-pkg1` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `kw-haw-pkg1`'s files. While this mechanism can
...
```
conda create -n kw-haw-pkg1 python=3 six virtualenv pytest pytest-cov
conda activate kw-haw-pkg1
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/kw-haw-pkg1.git
   cd kw-haw-pkg1
   ```
...
5. Install [pre-commit]:
   ...
   `kw-haw-pkg1` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/kw-haw-pkg1
[issue tracker]: https://github.com/<USERNAME>/kw-haw-pkg1/issues
